<template>
  <div>
    ...
    <el-pagination
      ...
      style="float: left"
    ></el-pagination>
    <el-button v-if="needBottom" type="primary" @click="exportExcel" style="float: right">导出表格</el-button>
    ...
    >
      ...
      >
        ...
        <div slot="tip" class="el-upload__tip">
          只能上传doc/docx/pdf/txt/zip/rar文件
        </div>
      </el-upload>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="uploadFileConfirm">{{
          modifyVisible ? "上传并反馈回写手" : "上传并提交至管理员"
        }}</el-button>
      </span>
    </el-dialog>
  </div>
